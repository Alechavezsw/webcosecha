  ...
  return (
    <section
      ...
      style={{
        ...
        ['--card-perspective' as any]: '700px',
        ['--card-z-offset' as any]: '12px',
        ['--card-y-offset' as any]: '7px',
        ['--card-max-z-index' as any]: imageList.length.toString(),
        ['--card-swap-duration' as any]: '0.3s',
      } as any}
    >
      {cardOrder.map((originalIndex, displayIndex) => (
        <article
          ...
          className="image-card absolute cursor-grab active:cursor-grabbing
                     place-self-center border border-neutral-700/60 rounded-2xl
                     shadow-[0_20px_50px_-15px_rgba(0,0,0,0.8)] overflow-hidden will-change-transform bg-neutral-900"
          style={{
            ['--i' as any]: (displayIndex + 1).toString(),
