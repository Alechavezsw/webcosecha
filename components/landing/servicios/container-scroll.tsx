...
type ContainerScrollProps = React.HTMLAttributes<HTMLDivElement> & {
  /** Motion scroll offsets; tune so hero scale matches sticky scroll distance. */
  scrollOffset?: NonNullable<NonNullable<Parameters<typeof useScroll>[0]>["offset"]>
}

export const ContainerScroll: React.FC<ContainerScrollProps> = ({
  children,
  className,
  scrollOffset = ["start center", "end end"],
  ...props
}) => {
