    ...
    <section id="security" ref={sectionRef} className="cc-aura cc-aura-violet relative py-32 lg:py-40 overflow-hidden">
      <div className="mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-12">
        <div className="mb-20">
          ...
          <h2 className={`mb-12 max-w-3xl text-2xl font-display leading-[1.1] tracking-tight transition-all duration-1000 sm:text-3xl md:text-4xl lg:text-5xl ${
          ...
          <div className={`transition-all duration-1000 delay-100 ${
            ...
            <p className="text-xl text-muted-foreground leading-relaxed max-w-2xl">
              Tus agentes son potentes y están acotados. Seguridad de nivel empresarial para que solo hagan lo que vos permitís.
            </p>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-12 gap-6">
          ...
          <div className={`lg:col-span-7 relative p-8 lg:p-12 border border-foreground/10 min-h-[400px] overflow-hidden transition-all duration-700 ${
            ...
            <div className="relative z-10">
              <span className="font-mono text-sm text-muted-foreground">Protección activa</span>
              <div className="mt-8">
                <span className="text-7xl lg:text-8xl font-display">0</span>
                <span className="block text-muted-foreground mt-2">Incidentes de seguridad este año</span>
              </div>
            </div>
