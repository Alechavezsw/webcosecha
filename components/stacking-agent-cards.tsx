...
const AGENTS = [
  {
    ...
    desc: "Creamos flujos inteligentes para automatizar tareas repetitivas como carga de datos, respuestas a clientes, generación de reportes, seguimiento comercial, gestión de consultas y organización interna.",
    stats: [{ v: "24/7", l: "operación autónoma" }, { v: "0", l: "errores humanos" }],
  ...
  },
  {
    ...
    desc: "Desarrollamos chatbots y asistentes con IA capaces de responder consultas, guiar clientes, tomar pedidos, brindar información y acompañar procesos comerciales o administrativos.",
    stats: [{ v: "< 3s", l: "tiempo de respuesta" }, { v: "100%", l: "cobertura comercial" }],
  ...
  },
  {
    ...
    desc: "Integramos agentes de inteligencia artificial con sistemas, planillas, CRM, WhatsApp, sitios web, bases de datos, correos y plataformas de gestión. Conectamos agentes de IA con las herramientas reales de tu empresa.",
    stats: [{ v: "100%", l: "conectores nativos" }, { v: "Multicanal", l: "integración total" }],
    img: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/coder-9bItvCegU6TXUqbX3tUXGBAtvkBkXp.png",
  },
  {
    label: "ANÁLISIS",
    title: "Análisis y toma de decisiones",
    desc: "Aplicamos IA para ordenar información, detectar oportunidades, interpretar datos, generar informes y mejorar la toma de decisiones estratégicas.",
    stats: [{ v: "100%", l: "trazabilidad" }, { v: "12x", l: "más velocidad" }],
    img: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/analyst-Ysxnqg7Fpy2cfA56PiIttv1KximMhT.png",
  },
  {
    label: "COMUNICACIÓN",
    title: "Contenido y comunicación potenciada",
    desc: "Usamos inteligencia artificial para optimizar campañas, generar ideas, mejorar textos, analizar audiencias y crear contenido más efectivo para redes sociales, sitios web y canales comerciales.",
    stats: [{ v: "3.5x", l: "más ideas" }, { v: "100%", l: "estrategia activa" }],
    img: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/coder-9bItvCegU6TXUqbX3tUXGBAtvkBkXp.png",
  },
]
