    ...
    <>
      <nav className={`fixed top-0 w-full z-[100] transition-all duration-700 ${scrolled ? 'glass-nav py-4' : 'bg-transparent py-10'}`}>
        <div className="max-w-[1800px] mx-auto px-10 flex justify-between items-center">
          <Magnetic>
            <div className="flex items-center gap-4 group cursor-pointer" onMouseEnter={onMouseEnter} onMouseLeave={onMouseLeave}>
          ...
          <div className="hidden lg:flex items-center gap-16">
            ...
            <Magnetic>
              <button 
                className="bg-white text-black px-10 py-4 rounded-full text-[11px] font-bold uppercase tracking-[0.2em] hover:bg-[#ffb800] hover:shadow-[0_0_32px_-8px_rgba(255,184,0,0.5)] transition-all duration-500"
                onMouseEnter={onMouseEnter} onMouseLeave={onMouseLeave}
              >
                Empezar
              </button>
